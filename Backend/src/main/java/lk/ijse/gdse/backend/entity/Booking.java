...
public class Booking {
    ...
    public Booking(Long bookingId, Vessel vessel, Berth berth, User agent, LocalDateTime bookingDate, LocalDateTime endDate, BookingPurpose purpose, String cargoCategory, Double cargoQuantity, BookingStatus status, LocalDateTime createdAt, List<BookingService> bookingServices) {
